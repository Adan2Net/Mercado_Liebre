...
CREATE TABLE users (id INT NOT NULL AUTO_INCREMENT, name varchar(45), email varchar(45) unique, password varchar(45), id_roles INT, primary key(id), foreign key(id_roles) references roles(id));
